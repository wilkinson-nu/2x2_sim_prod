...
Running edep-disp requires Mesa drivers on the host machine. If you're using Ubuntu, it'll already be there. If it's some redhat based distro, you can install them with the mesa-dri-drivers package. 
